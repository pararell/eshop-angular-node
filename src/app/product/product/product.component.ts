...
export class ProductComponent {
  ...
  constructor(
    ...
    combineLatest(this.lang$, this._route.params.pipe(map(params => params['id'])), (lang, id) => ({ lang, id })).subscribe(({ lang, id }) => this.store.dispatch(new actions.GetProduct(id + '/' + lang)));
